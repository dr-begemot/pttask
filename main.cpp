...
int main(int argc, const char * argv[]) {
    ...
    vec.insert(vec.end(), strs[1].begin(), strs[1].end()-strs[1].size()/2);// start of 8th pack
    npack+=receiver.receive(vec.data(), vec.size());
    //<--7 pack
    cout<<"<<"<<npack<<" pack\n";
    vec.erase(vec.begin(), vec.end());
    vec.insert(vec.end(), strs[1].end()-strs[1].size()/2, strs[1].end());// end of 8th pack
    ...
    cout<<"<<"<<npack<<" pack\n";
    vec.erase(vec.begin(), vec.end());
    vec.insert(vec.end(), bin2+sizeof(bin2)/2, bin2+sizeof(bin2));//end of 15th pack
    vec.insert(vec.end(), strs[1].begin(), strs[1].end()-strs[1].size()/2);//start of 16th pack
    npack+=receiver.receive(vec.data(), vec.size());
    //<--15 pack
    cout<<"<<"<<npack<<" pack\n";
    vec.erase(vec.begin(), vec.end());
    vec.insert(vec.end(), strs[1].end()-strs[1].size()/2, strs[1].end());// end of 16th pack
    vec.insert(vec.end(), strs[2].begin(), strs[2].end());
    vec.insert(vec.end(), bin1, bin1+sizeof(bin1));
    npack+=receiver.receive(vec.data(), vec.size());
    //<--18 pack
    cout<<"<<"<<npack<<" pack\n";
    vec.erase(vec.begin(), vec.end());
    vec.insert(vec.end(), strs[5].begin(), strs[5].end()-1);
    npack+=receiver.receive(vec.data(), vec.size());
    cout<<"<<"<<npack<<" pack\n";
    vec.erase(vec.begin(), vec.end());
    vec.insert(vec.end(), strs[5].end()-1, strs[5].end());
    npack+=receiver.receive(vec.data(), vec.size());
    //<--19 pack
    cout<<"<<"<<npack<<" pack\n";
